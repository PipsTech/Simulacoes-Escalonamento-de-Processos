...
public class Pedido {
    ...
    public String toString() {
        ...
        return "nome: " + nome + ", chegada: "+chegada+", nprodutos: " + nprodutos + ", prazo: " + prazo + ", tempo de finalização(min): "+df.format(tempo)+", Atendimento: "+att+", Prazo cumprido? "+this.cumpriuPrazo()+ "]";
    }
    public String help() {
       
        DecimalFormat df = new DecimalFormat("##.###");
        return "nome: " + nome + ", chegada: "+chegada+"\t, nprodutos: " + nprodutos +"\t, tempo de finalização(min): "+df.format(tempo)+ "]";
    }
